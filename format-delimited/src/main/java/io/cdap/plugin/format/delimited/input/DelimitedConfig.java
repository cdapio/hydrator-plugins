...
public class DelimitedConfig extends PathTrackingConfig {
  ...
  private static final String CLEANSE_QUOTES_DESC = "Whether to cleanse all the quotes in the record. " +
                                                      "Default value is false.";
  ...
  static {
    ...
    fields.put("skipHeader", new PluginPropertyField("skipHeader", SKIP_HEADER_DESC,
                                                     "boolean", false, true));
    fields.put("cleanseQuotes", new PluginPropertyField("filenameOnly", CLEANSE_QUOTES_DESC,
                                                             "boolean", false, true));
  ...
  @Macro
  @Nullable
  @Description(CLEANSE_QUOTES_DESC)
  ...
  boolean getCleanseQuotes() {
    return cleanseQuotes == null ? false : cleanseQuotes;
  }
}
