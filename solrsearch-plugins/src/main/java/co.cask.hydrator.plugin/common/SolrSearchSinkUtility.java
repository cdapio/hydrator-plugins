...
/**
 * Utility class for SolrSearchSink and RealtimeSolrSearchSink plugins.
 */
public class SolrSearchSinkUtility {
   ...
   * @return Solr client
   */
  public static SolrClient getSolrConnection(SolrSearchSinkConfig config) {
    String urlString;
   ...
   */
  public static void validateSolrConnectionString(SolrSearchSinkConfig config) {
   ...
   */
  public static void verifySolrConfiguration(SolrSearchSinkConfig config) {
    SolrClient client = getSolrConnection(config);
    try {
      client.ping();
    } catch (Exception e) {
   ...
   * @param inputSchema
   */
  public static void validateIdField(Schema inputSchema, SolrSearchSinkConfig config) {
   ...
   * @param inputSchema
   */
  public static void validateInputFieldsDataType(Schema inputSchema) {
