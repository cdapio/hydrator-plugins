...
Description
-----------
Action that runs a database script.


Use Case
--------
The action can be used whenever you want to run a database script before or after a data pipeline.
For example, you may want to run a sql update command on a database before the pipeline source pulls data from tables.


Properties
----------
**scriptPath:** The file path of the database script to execute.
