  ...
  public void testESSink() throws Exception {
    ...
    try {
      ETLStage sink = new ETLStage("Elasticsearch",
                                   ImmutableMap.of(ElasticsearchSink.Elasticsearch.HOST, "localhost:9200",
                                                   ElasticsearchSink.Elasticsearch.INDEX_NAME, "test",
                                                   ElasticsearchSink.Elasticsearch.TYPE_NAME, "testing",
                                                   ElasticsearchSink.Elasticsearch.ID_FIELD, "ticker"
                                   ));
