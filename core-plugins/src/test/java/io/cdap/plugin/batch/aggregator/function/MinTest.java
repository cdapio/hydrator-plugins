...
public class MinTest extends NumberTest {
  ...
  public void testIntMin() {
    ...
    Min min1 = new Min("x", Schema.of(Schema.Type.INT));
    testFunction(min, schema, min1, 99, 99, 100, 101);
    testFunction(min, schema, min1, -100, -100, 0, 3, 100);
    testFunction(min, schema, min1, -5, -5, -5);
  }
  ...
  public void testLongMin() {
    ...
    Min min1 = new Min("x", Schema.of(Schema.Type.LONG));
  ...
  public void testFloatMin() {
    ...
    Min min1 = new Min("x", Schema.of(Schema.Type.FLOAT));
  ...
  public void testDoubleMin() {
    ...
    Min min1 = new Min("x", Schema.of(Schema.Type.DOUBLE));
