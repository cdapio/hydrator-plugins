...
public class LogicalOrIfTest extends AggregateFunctionTest {
  ...
  public void testCondition() {
    ...
    test(new LogicalOrIf("x", fieldSchema, JexlCondition.of(condition)), schema, "x", true,
         Arrays.asList(false, false, true),
         new LogicalOrIf("x", fieldSchema, JexlCondition.of(condition)));
    test(new LogicalOrIf("x", fieldSchema, JexlCondition.of(condition)), schema, "x", false,
