...
public class FileConnector implements BatchConnector<LongWritable, Text> {
  ...
  public FileConnector(FileConfig fileConfig) {
   ...
   *
   */
  public static class FileConfig extends PluginConfig {
    @Nullable
    ...
    public FileConfig(@Nullable String path, @Nullable String dummy) {
      this.path = path;
      this.dummy = dummy;
    }
  }
