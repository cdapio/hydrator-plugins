...
public class TimePartitionedFileSetDatasetParquetSource extends TimePartitionedFileSetSource<TPFSConfig> {

  public TimePartitionedFileSetDatasetParquetSource(TPFSConfig tpfsParquetConfig) {
  ...
  protected void addFileSetProperties(FileSetProperties.Builder properties) {
    FileSetUtil.configureParquetFileSet(config.getSchema().toString(), properties);
  }
