...
public class AvroFileSource extends ReferenceBatchSource<AvroKey<GenericRecord>, NullWritable, StructuredRecord> {
  ...
  public AvroFileSource(ParquetFileConfig config) {
    super(config);
    this.config = config;
  }
  ...
  public void prepareRun(BatchSourceContext context) throws Exception {
    ...
    context.setInput(Input.of(config.referenceName,
                              new SourceInputFormatProvider(AvroKeyInputFormat.class.getName(), conf)));
  }

  @Override
  public void transform(KeyValue<AvroKey<GenericRecord>, NullWritable> input,
                        Emitter<StructuredRecord> emitter) throws Exception {
    emitter.emit(recordTransformer.transform(input.getKey().datum(), outputSchema));
  }
