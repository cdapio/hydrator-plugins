...
public class FilePlugin implements CdfHelper {
  ...
  @Then("Override output schema for File plugin with: {string}")
  public void overrideOutputSchemaForFilePluginWith(String jsonOverrideFieldList) {
    FileActions.overrideOutputSchema(jsonOverrideFieldList);
  }
}
