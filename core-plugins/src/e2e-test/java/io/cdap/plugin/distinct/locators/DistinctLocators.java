 ...
 * the License.
 */
package io.cdap.plugin.distinct.locators;
...
/**
 * Distinct Related Locators.
 */
public class DistinctLocators {
  ...
  public static WebElement listOfFields(int row) {
    String xpath = "//*[@data-cy='fields']//*[@data-cy= '" + row + "']//*[@data-cy='key']/input";
    return SeleniumDriver.getDriver().findElement(By.xpath(xpath));
  }

  public static WebElement fieldAddRowButton(int row) {
    String xpath = "//*[@data-cy='fields']//*[@data-cy='" + row + "']//button[@data-cy='add-row']";
    return SeleniumDriver.getDriver().findElement(By.xpath(xpath));
  }
}
