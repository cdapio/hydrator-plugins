...
public class SparkPluginTest extends HydratorTestBase {
  ...
  public static void setupTest() throws Exception {
    ...
    addPluginArtifact(NamespaceId.DEFAULT.artifact("spark-plugins", "1.0.0"), parents, KafkaUtils.class,
                      DefaultDecoder.class, TopicAndPartition.class, TwitterStreamingSource.class,
