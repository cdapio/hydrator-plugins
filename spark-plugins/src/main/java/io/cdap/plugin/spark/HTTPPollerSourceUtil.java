...
/**
 * Util methods for {@link HTTPPollerSource}.
 *
 * This class is added to abstract out spark class to support validation for {@link HTTPPollerSource}.
 */
class HTTPPollerSourceUtil {
   ...
   */
  static Receiver<StructuredRecord> getJavaReceiverInputDStream(HTTPPollConfig conf) {
