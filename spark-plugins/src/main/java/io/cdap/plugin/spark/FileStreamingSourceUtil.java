...
/**
 * Util methods for {@link FileStreamingSource}.
 *
 * This class is added to abstract out spark class to support validation for {@link FileStreamingSource}.
 */
class FileStreamingSourceUtil {
   ...
   * @param conf file streaming conf
   */
