...
/**
 * Copied from Parquet-mr library to port the fix for (PARQUET-1802).
 * This class can be deleted after PARQUET-1802 is released and we switch to parquet version which
 * contains that fix.
 */
class CodecFactory {
