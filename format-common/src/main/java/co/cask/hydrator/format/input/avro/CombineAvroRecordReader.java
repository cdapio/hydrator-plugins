 ...
 */
public class CombineAvroRecordReader extends CombineFileRecordReaderWrapper<NullWritable, StructuredRecord> {

  public CombineAvroRecordReader(CombineFileSplit split, TaskAttemptContext context,
                                 Integer idx) throws IOException, InterruptedException {
    super(new PathTrackingAvroInputFormat(), split, context, idx);
  }
}
