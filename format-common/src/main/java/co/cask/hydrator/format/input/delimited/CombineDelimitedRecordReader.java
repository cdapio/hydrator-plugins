 ...
 */
public class CombineDelimitedRecordReader extends CombineFileRecordReaderWrapper<NullWritable, StructuredRecord> {

  public CombineDelimitedRecordReader(CombineFileSplit split, TaskAttemptContext context,
                                      Integer idx) throws IOException, InterruptedException {
    super(new PathTrackingDelimitedInputFormat(), split, context, idx);
  }
}
