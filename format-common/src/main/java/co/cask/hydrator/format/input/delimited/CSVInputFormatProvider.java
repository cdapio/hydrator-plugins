...
@Name("csv")
@Description("CSV text input format plugin for file based plugins.")
public class CSVInputFormatProvider extends
  PathTrackingInputFormatProvider<InputFormatConfig> {

  public CSVInputFormatProvider(InputFormatConfig conf) {
    super(conf);
  }
