 ...
 */
public class CombineJsonRecordReader extends CombineFileRecordReaderWrapper<NullWritable, StructuredRecord> {

  public CombineJsonRecordReader(CombineFileSplit split, TaskAttemptContext context,
                                 Integer idx) throws IOException, InterruptedException {
    super(new PathTrackingJsonInputFormat(), split, context, idx);
  }
}
